defmodule EctoTurboTest do
  @moduledoc """
  EctoTurbo Enties Test
  """
  ...
  describe "test with turbo opts" do
    ...
    test "opts with queryable callback" do
      ...
      %{data: data} = TE.turbo(Post, %{}, turbo_opts)
    ...
    test "opts with repo" do
      post_fixture()
      turbo_opts = [repo: EctoTurbo.TestRepo]
      %{data: data} = TE.turbo(Post, %{}, turbo_opts)
      assert length(data) == 3
    end
  end
  ...
  describe "test with assco" do
    test "combinator with :and" do
      post_fixture()
      %{data: data} = do_run_search(%{"name_and_category_name_eq" => "post-name-1"})
      assert length(data) == 1
    end

    test "combinator with :or" do
      post_fixture()
      %{data: data} = do_run_search(%{"name_or_category_name_eq" => "category-name-11"})
      assert length(data) == 1
    end
  end
  ...
  describe "test with sort" do
    test "sort asc" do
      post_fixture()
      %{data: data} = TE.turbo(Post, %{"sort" => "price+asc"})
      assert hd(data) |> Map.get(:price) == 10
    end

    test "sort desc" do
      post_fixture()
      %{data: data} = TE.turbo(Post, %{"sort" => "price+desc"})
      assert hd(data) |> Map.get(:price) == 30
    end
  end
  ...
  describe "test search_types" do
    test "When search_types is :eq" do
      ...
      assert do_build_search(filter) ==
               "#Ecto.Query<from p0 in EctoTurbo.Schemas.Post, where: p0.price == type(^10, p0.price), limit: ^10, offset: ^0>"
    ...
    test "When search_types is :not_eq" do
      ...
      assert do_build_search(filter) ==
               "#Ecto.Query<from p0 in EctoTurbo.Schemas.Post, where: p0.price != type(^30, p0.price), limit: ^10, offset: ^0>"
    ...
    test "When search_types is :lt" do
      ...
      assert do_build_search(filter) ==
               "#Ecto.Query<from p0 in EctoTurbo.Schemas.Post, where: p0.price < type(^20, p0.price), limit: ^10, offset: ^0>"
    ...
    test "When search_type is :in" do
      ...
      assert do_build_search(filter) ==
               "#Ecto.Query<from p0 in EctoTurbo.Schemas.Post, where: p0.price in type(^[10, 20], {:array, p0.price}), limit: ^10, offset: ^0>"
    ...
    test "When search_type is :not_in" do
      ...
      assert do_build_search(filter) ==
               "#Ecto.Query<from p0 in EctoTurbo.Schemas.Post, where: p0.price not in type(^[10, 20], {:array, p0.price}), limit: ^10, offset: ^0>"
    ...
    test "When search_type is :is_true" do
      ...
      assert do_build_search(filter) ==
               "#Ecto.Query<from p0 in EctoTurbo.Schemas.Post, where: p0.available == type(^true, p0.available), limit: ^10, offset: ^0>"
    ...
    test "When search_type is :is_false" do
      ...
      assert do_build_search(filter) ==
               "#Ecto.Query<from p0 in EctoTurbo.Schemas.Post, where: p0.available == type(^false, p0.available), limit: ^10, offset: ^0>"
    ...
    test "When search_type is between" do
      ...
      assert do_build_search(filter) ==
               "#Ecto.Query<from p0 in EctoTurbo.Schemas.Post, where: type(^9, p0.price) < p0.price and p0.price < type(^21, p0.price), limit: ^10, offset: ^0>"

      post_fixture()
      %{data: data} = do_run_search(filter)
      assert length(data) == 2

      %{data: data_2} = do_run_search(%{"price_between" => "9..21"})
      assert length(data_2) == 2
    end
  end
